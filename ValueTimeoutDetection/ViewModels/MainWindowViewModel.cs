...
namespace ValueTimeoutDetection.ViewModels
{
    public class MainWindowViewModel : ViewModel
    {
        public MainWindowViewModel()
        {
            ...
            MyPropertyTriggeredTime = MyProperty.Select(x => DateTime.Now).ToReadOnlyReactivePropertySlim();
            ...
            MyPropertyExpiredTime = IsMyPropertyExpired.Select(x => DateTime.Now).ToReadOnlyReactivePropertySlim();
        }
